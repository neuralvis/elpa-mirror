...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-group-news-3-empty ((,class (:foreground ,cyan-alt))))
   `(gnus-group-news-4 ((,class (:foreground ,magenta-refine-fg :weight bold))))
   `(gnus-group-news-4-empty ((,class (:foreground ,magenta-refine-fg))))
   `(gnus-group-news-5 ((,class (:foreground ,yellow-refine-fg :weight bold))))
   `(gnus-group-news-5-empty ((,class (:foreground ,yellow-refine-fg))))
   `(gnus-group-news-6 ((,class (:foreground ,red-refine-fg :weight bold))))
   `(gnus-group-news-6-empty ((,class (:foreground ,red-refine-fg))))
   `(gnus-group-news-low ((,class (:foreground ,fg-special-warm :weight bold))))
   `(gnus-group-news-low-empty ((,class (:foreground ,fg-special-warm))))
