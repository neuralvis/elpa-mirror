...
let p = streamReplace tidal
    ...
    clutch t = transition tidal (Sound.Tidal.Transition.clutch t)
    clutchIn t = transition tidal (Sound.Tidal.Transition.clutchIn t)
    anticipate t = transition tidal (Sound.Tidal.Transition.anticipate t)
