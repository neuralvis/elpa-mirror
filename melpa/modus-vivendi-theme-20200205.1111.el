...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(gnus-group-news-4 ((,class (:foreground ,yellow-refine-fg :weight bold))))
   `(gnus-group-news-4-empty ((,class (:foreground ,yellow-refine-fg))))
   `(gnus-group-news-5 ((,class (:foreground ,red-refine-fg :weight bold))))
   `(gnus-group-news-5-empty ((,class (:foreground ,red-refine-fg))))
   `(gnus-group-news-6 ((,class (:foreground ,fg-special-mild :weight bold))))
   `(gnus-group-news-6-empty ((,class (:foreground ,fg-special-mild))))
