...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(ivy-minibuffer-match-face-3 ((,class (:inherit modus-theme-subtle-green))))
   ...
   `(swiper-background-match-face-2 ((,class (:inherit modus-theme-subtle-green))))
   `(swiper-background-match-face-3 ((,class (:inherit modus-theme-subtle-green))))
   `(swiper-background-match-face-4 ((,class (:inherit modus-theme-subtle-green))))
   `(swiper-line-face ((,class (:inherit modus-theme-special-cold :weight bold))))
   `(swiper-match-face-1 ((,class (:inherit modus-theme-intense-green))))
   `(swiper-match-face-2 ((,class (:inherit modus-theme-intense-green))))
   `(swiper-match-face-3 ((,class (:inherit modus-theme-intense-green))))
