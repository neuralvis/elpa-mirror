...
(defun spell-fu-region (&optional point-start point-end)
  ...
  (when font-lock-mode
    (font-lock-ensure point-start point-end))
  ...
  (funcall spell-fu-check-range (or point-start (point-min)) (or point-end (point-max))))
